...
const cs336Demo: ProjectDemo = {
  ...
  planRevision: 1,
  planPhases: [
    { id: "cs-phase-1", order: 1, title: "Build the global map", description: "Understand the course position, language-model objective, and end-to-end training pipeline.", window: "Weeks 1–2", status: "Complete", milestones: ["CS336 overview and LLM production flow", "Language-model objective and perplexity"] },
