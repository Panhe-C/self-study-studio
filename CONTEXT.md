...
_Gap_: Repository purge commits first and attachment cleanup is retryable through a local private queue when the filesystem reports a failure; physical-device acceptance remains unverified.
