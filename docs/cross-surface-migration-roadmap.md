...
project-scoped Trash export, retryable local attachment cleanup, strict canonical transport
rejection, and dependency-safe permanent deletion. Verification: `swift test` 316 tests / 0
